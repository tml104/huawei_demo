...
public:
	...
	void set_sheets_to_extract (std::vector<DualSheet *> & _sheets);
	DualSheet *get_sheet_to_extract () {return sheet_to_extract;}
	std::vector<DualSheet *> get_sheets_to_extract () {return sheets_to_extract;}
...
private:
	...
	std::vector<DualSheet *> sheets_to_extract;
